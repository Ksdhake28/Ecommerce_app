...
function ProductCard(props) {
    ...
    return (
        <div  className="p-4 m-2 bg-white shadow-md rounded-lg w-64 border-2 border-gray-200 text-center items-center justify-center hover:shadow-lg transition-all font-display">
            <div onClick={() => displayDetails(props.id)} className="h-40 flex justify-center item-center cursor-pointer">
            ...
            <div className="mt-5 font-display flex flex-col flex-grow">
                ...
                <div className="flex items-center justify-center cursor-pointer">
                    {inCart ? (
                        <QtySetter onQtyChange={handleQtyChange} product={props} />
                    ) : (
                ...
                <button onClick={() => displayDetails(props.id)} className="cursor-pointer m-2 bg-blue-500 text-white rounded-md flex gap-3 px-3 py-1 items-center justify-center hover:bg-blue-600 transition">View details</button>
                </div>
            </div>
        </div>
    );
